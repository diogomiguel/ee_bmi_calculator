...
class Bmi_calculator
{
    ...
    function bmi_form()
    {
        ...
        $form_data = array(
            ...
            'action' => $this->EE->functions->fetch_site_index() . QUERY_MARKER . 'ACT=' . $this->EE->functions->fetch_action_id('Bmi_calculator', 'form_submission')
        );
    ...
    function form_submission()
    {
        ...
        if ($this->EE->input->is_ajax_request()) {
            if ($bmi === FALSE) {
                $response = array(
                    'success' => false,
                    'errors' => lang('bmi_calculator_error')
                );
            } else {
                $response = array(
                    'success' => true,
